...
export const offerSummaries: OfferSummary[] = [
  ...
  },
  {
    ...
    topicKey: "algebraic-viewpoints",
    title: "Controlled Lawvere theories: cartesian PROPs with structured control",
    status: "Tomorrow-problem",
    statusClass: "pill--incubating",
    fitBadge: "Fit: PhD or very strong M2",
    fit: "Best for someone who likes categorical definitions but also wants a concrete finite-field example to keep the abstraction honest.",
    background: "Lawvere theories, cartesian PROPs, controlled / polycontrolled PROPs, and finite-field polynomial semantics.",
    scope: "Scope: deep and foundational",
    output: "A clean definition of controlled Lawvere theory, plus examples around q-reduced finite-field polynomial functions and controlled classical gates.",
    firstMilestone: "Write the minimal definition as a cartesian controlled PROP and verify the finite-field control construction on small endomorphisms.",
  },
  {
  ...
  },
  {
    ...
    topicKey: "equational-theory",
    title: "Explore the expressivity of $X^{a,b}{,}$ CX, and a few phase gates",
    status: "Current focus",
    statusClass: "pill--focus",
    fitBadge: "Fit: advanced M2 or PhD",
    fit: "Best for someone who likes finite-field circuit structure, explicit decompositions, and turning a draft into a sharp theorem-level story.",
    background: "Prime-dimensional qudits, local transpositions, controlled addition, phase gates, and finite-field phase profiles.",
    scope: "Scope: deep",
    output: "A polished account of what the sparse gate set $\\{X^{a,b}, \\mathrm{CX}, Z\\}$ already expresses in prime dimension, with clean examples and synthesis statements.",
    firstMilestone: "Polish the current cs_decomp notes into a talk-ready narrative around p >= 5, zero-sum diagonals, CZ/CCZ, and controlled phase gates.",
  },
  {

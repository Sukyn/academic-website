...
export const offerSummaries: OfferSummary[] = [
  ...
  },
  {
    ...
    topicKey: "algebraic-viewpoints",
    title: "Promised PROPs: combine promise-style controls with controlled / polycontrolled PROPs",
    status: "Tomorrow-problem",
    statusClass: "pill--incubating",
    fitBadge: "Fit: PhD or very strong M2",
    fit: "Best for someone who enjoys categorical structure, comparing definitions across papers, and extracting the right common language.",
    background: "PROPs, string diagrams, controlled structure, and enough circuit theory to keep the abstraction honest.",
    scope: "Scope: deep and foundational",
    output: "A candidate promise-sensitive control formalism with core equations and one worked circuit application.",
    firstMilestone: "Translate a small promise-style fragment into the controlled-PROP language and test whether ancilla-for-control conversion becomes structural.",
  },
  {
  ...
  },
  {
    ...
    topicKey: "equational-theory",
    title: "Add the two-level X^{a,b} gate to prime-dimensional phase-affine circuits",
    status: "Open / exploratory",
    statusClass: "pill--open",
    fitBadge: "Fit: advanced M2 or PhD",
    fit: "Best for someone who likes taking a clean fragment and seeing exactly which structural properties survive one extra generator.",
    background: "Finite fields, monomial circuit structure, and patience for examples before theorem statements.",
    scope: "Scope: deep",
    output: "Either an extended monomial normal form or a sharp obstruction showing where the current methods break.",
    firstMilestone: "Work out whether adjoining one two-level X generator preserves a usable normal form on one-wire and two-wire examples.",
  },
  {

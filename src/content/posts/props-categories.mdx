...
description: "A serious-but-accessible introduction to categories, PROs/PROPs, and the idea of treating control as structure--background for complete rewrite rulebooks for (qudit) quantum circuits."
...
If you want a friendly motivational video, this one has the right vibe:
